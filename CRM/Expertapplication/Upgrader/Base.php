 ...
 */
class CRM_Expertapplication_Upgrader_Base {
  ...
  static public function instance() {
    if (! self::$instance) {
      // FIXME auto-generate
      self::$instance = new CRM_Expertapplication_Upgrader(
   ...
   *
   * @code
   * CRM_Expertapplication_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * @endcode
   */
