 ...
 *
 */
class CRM_Expertapplication_Form_Report_MyApplications extends CRM_Report_Form {
    ...
    $this->_columns = array(
      ...
      array(
        ...
        array(
          ...
          'status_id' => array('title' => ts('Case Status'), 'default' => true,),
...
";
  ...
  function where() {
    ...
    if (isset($this->_params['case_role_value']) && is_array($this->_params['case_role_value']) && count($this->_params['case_role_value'])) {
      $session   = CRM_Core_Session::singleton();
      $userID    = $session->get('userID');
      $clauses[] = "({$this->_aliases['civicrm_relationship']}.contact_id_a = {$userID} OR {$this->_aliases['civicrm_relationship']}.contact_id_b = {$userID})";
    }
