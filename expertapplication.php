...
function expertapplication_civicrm_custom($op, $groupID, $entityID, &$params) {
  CRM_Expertapplication_Hooks_CustomCaseStatusReject::custom($op, $groupID, $entityID, $params);
}
